...
#define CMD_INA_STR 0x20
#define CMD_INA_STP 0x21

#define CMD_I2C_PWR 0x40 // I2C power On/Off
...
typedef struct __attribute__((packed)) _dev_i2c_cfg_t {
	...
	uint16_t clk_khz; 	// частота i2c шины в kHz,  |= 0x8000 - stretch enable
...
#define APP_RX_BUFFER_LENGTH  (DLE_DATA_SIZE+2)
extern volatile uint16_t app_cmd_len;
