...
void board_spi0_gpio_init()
{
    ...
    gpio = bflb_device_get_by_name("gpio");
    /* SPI0_SCLK */
    bflb_gpio_init(gpio, GPIO_PIN_15, GPIO_FUNC_SPI0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1); // TCK
    /* SPI0_MOSI/MISO  */
    bflb_gpio_init(gpio, GPIO_PIN_0, GPIO_FUNC_SPI0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1); // TDI
    /* SPI0_MISO/MOSI */
    bflb_gpio_init(gpio, GPIO_PIN_1, GPIO_FUNC_SPI0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1); // TDO
    /* SPI0_SS */
    bflb_gpio_init(gpio, GPIO_PIN_2, GPIO_FUNC_SPI0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1); // TMS
}
...
void board_adc_gpio_init()
{
    ...
    gpio = bflb_device_get_by_name("gpio");
    // bflb_gpio_init(gpio, GPIO_PIN_9, GPIO_ANALOG | GPIO_SMT_EN | GPIO_DRV_0); // LED0
    bflb_gpio_init(gpio, GPIO_PIN_15, GPIO_ANALOG | GPIO_SMT_EN | GPIO_DRV_0); // RV-Debuger ADC-TCK
}
...
void board_dac_gpio_init()
{
    ...
    /* DAC_CHB */
    bflb_gpio_init(gpio, GPIO_PIN_17, GPIO_ANALOG | GPIO_SMT_EN | GPIO_DRV_0); // LED1
}
