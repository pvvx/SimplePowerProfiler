object frmMain: TfrmMain
  ...
  object Panel1: TPanel
    ...
    object ButtonStartADC: TButton
      ...
      TabOrder = 9
      Visible = False
      OnClick = ButtonStartADCClick
    end
    object ButtonADCcfg: TButton
      Left = 636
      Top = 8
      Width = 65
      Height = 21
      Hint = 'Configuration ADC'
      Caption = 'ADC Config'
      Enabled = False
      ParentShowHint = False
      ShowHint = True
  ...
  object Panel2: TPanel
    ...
    object ButtonSaveWav: TButton
      ...
      Width = 65
      Height = 21
      Hint = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1076#1072#1085#1085#1099#1077' '#1074' wav '#1092#1072#1081#1083
      Caption = 'Save wav'
      ParentShowHint = False
      ShowHint = True
      TabOrder = 12
